...
#define GATT SERVICE UUID                                                                0x183B // Binary Sensor
...
#define GATT SERVICE UUID                                                                0x183C // Emergency Configuration
...
#define GATT CHARACTERISTIC UUID                                                         0x2B2B // BSS Control Point
#define GATT CHARACTERISTIC UUID                                                         0x2B2C // BSS Response
...
#define GATT CHARACTERISTIC UUID                                                         0x2B2A // Database Hash
...
#define GATT CHARACTERISTIC UUID                                                         0x2B2D // Emergency ID
#define GATT CHARACTERISTIC UUID                                                         0x2B2E // Emergency Text
...
#define GATT CHARACTERISTIC UUID                                                         0x2B37 // Registered User Characteristic
